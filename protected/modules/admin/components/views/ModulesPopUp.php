<?php
$sqldata = "select moduleid,modulename,description  
		from modules 
		where recordstatus = 1 and modulename like '%".(isset($_REQUEST['modulename'])
		? $_REQUEST['modulename'] : '')."%'";
