...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'currencyname': $("input[name='<?php echo $this->IDField; ?>_search_currencyname']").val(),
  ...
  <div class="modal-dialog modal-lg">	
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4">
            <label class="control-label" for="<?php echo $this->IDField; ?>_search_currencyname"><?php echo getCatalog('currencyname') ?></label>
          </div>
          <div class="col-md-8">
            <div class="input-group">
              <input type="text" name="<?php echo $this->IDField; ?>_search_currencyname" class="form-control">
              <span class="input-group-btn">
