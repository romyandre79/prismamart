<?php
$sqldata = "select languageid,languagename  
		from language 
		where recordstatus = 1 and languagename like '%".(isset($_REQUEST['languagename'])
		? $_REQUEST['languagename'] : '')."%'";
...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'languagename': $("input[name='<?php echo $this->IDField; ?>_search_languagename']").val()
			}});
		return false;
	}
...
<div id="<?php echo $this->IDDialog ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">	
      ...
      <div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField; ?>_search_languagename"><?php echo getCatalog('languagename') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField; ?>_search_languagename" class="form-control">
							<span class="input-group-btn">
