<?php
$sqldata = "select workflowid,wfname,wfdesc
		from workflow 
		where recordstatus = 1 
		and wfname like '%".(isset($_REQUEST['wfname']) ? $_REQUEST['wfname'] : '')."%'
		and wfdesc like '%".(isset($_REQUEST['wfdesc']) ? $_REQUEST['wfdesc'] : '')."%'
		";
...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'wfname': $("input[name='<?php echo $this->IDField; ?>_search_wfname']").val(),
				'wfdesc': $("input[name='<?php echo $this->IDField; ?>_search_wfdesc']").val()
			}});
		return false;
	}
...
<div id="<?php echo $this->IDDialog ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">	
      ...
      <div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField; ?>_search_wfname"><?php echo getCatalog('wfname') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField; ?>_search_wfname" class="form-control">
							<span class="input-group-btn">
				...
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField; ?>_search_wfdesc"><?php echo getCatalog('wfdesc') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField; ?>_search_wfdesc" class="form-control">
						</div>
					</div>
				</div>
				<?php
