<?php
$sqldata = "select a.snroid,a.description,a.formatdoc,a.formatno,a.repeatby
		from snro a 
		where a.recordstatus = 1 
		and a.formatdoc like '%".(isset($_REQUEST['formatdoc']) ? $_REQUEST['formatdoc']
		: '')."%'
...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'formatdoc': $("input[name='<?php echo $this->IDField ?>_search_formatdoc']").val(),
...
<div class="row">
	...
	<div class="<?php echo $this->classtypebox ?>">
		...
		<div class="input-group">
			<input type="text" name="<?php echo $this->IDField ?>" readonly class="form-control">
...
<div id="<?php echo $this->IDDialog ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">	
      ...
      <div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField ?>_search_formatdoc"><?php echo getCatalog('formatdoc') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField ?>_search_formatdoc" class="form-control">
							<span class="input-group-btn">
