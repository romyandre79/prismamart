<script src="<?php echo Yii::app()->baseUrl; ?>/js/common/salesarea.js"></script>
<script src="<?php echo Yii::app()->theme->baseUrl;?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<div class="card card-purple">
	<div class="card-header with-border">
		<h3 class="card-title"><?php echo getCatalog('salesarea') ?></h3>
	</div>
	<div class="card-body">
    <?php $this->widget('Button',	array('menuname'=>'salesarea')); ?>
		<?php
				...
				array
					...
					'buttons' => array
						...
						'edit' => array
							...
							'visible' => booltostr(CheckAccess('salesarea', 'iswrite')),
							'url' => '"#"',
							'click' => "function() {
						...
						'delete' => array
							...
							'visible' => booltostr(CheckAccess('salesarea', 'isreject')),
							'url' => '"#"',
							'click' => "function() {
						...
						'purge' => array
							...
							'visible' => booltostr(CheckAccess('salesarea', 'ispurge')),
							'url' => '"#"',
							'click' => "function() {
						...
						'pdf' => array
							...
							'visible' => booltostr(CheckAccess('salesarea', 'isdownload')),
							'url' => '"#"',
							'click' => "function() {
...
<?php $this->widget('HelpPopUp',array('helpurl'=>'https://www.youtube.com/embed/WOj4uT1x6vg')); ?>
<div id="InputDialog" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      <h4 class="modal-title"><?php echo getCatalog('salesarea') ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
				<input type="hidden" class="form-control" name="actiontype">
				<input type="hidden" class="form-control" name="salesareaid">
        <div class="row">
					<div class="col-md-4">
						<label for="areaname"><?php echo getCatalog('areaname') ?></label>
					</div>
					<div class="col-md-8">
