<script src="<?php echo Yii::app()->baseUrl; ?>/js/common/tax.js"></script>
<script src="<?php echo Yii::app()->theme->baseUrl;?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<div class="card card-purple">
	<div class="card-header with-border">
		<h3 class="card-title"><?php echo getCatalog('tax') ?></h3>
	</div>
	<div class="card-body">
    <?php $this->widget('Button',	array('menuname'=>'tax')); ?>
		<?php
				...
				array
					...
					'buttons' => array
						...
						'edit' => array
							...
							'visible' => booltostr(CheckAccess('tax', 'iswrite')),
							'url' => '"#"',
							'click' => "function() {
						...
						'delete' => array
							...
							'visible' => booltostr(CheckAccess('tax', 'isreject')),
							'url' => '"#"',
							'click' => "function() {
						...
						'purge' => array
							...
							'visible' => booltostr(CheckAccess('tax', 'ispurge')),
							'url' => '"#"',
							'click' => "function() {
						...
						'pdf' => array
							...
							'visible' => booltostr(CheckAccess('tax', 'isdownload')),
							'url' => '"#"',
							'click' => "function() {
...
<?php $this->widget('SearchPopUp',array('searchitems'=>array(
  array('searchtype'=>'text','searchname'=>'taxcode'),
  array('searchtype'=>'text','searchname'=>'description')
))); ?>
<?php $this->widget('HelpPopUp',array('helpurl'=>'https://www.youtube.com/embed/VdHtsy9-oG8')); ?>
<div id="InputDialog" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      <h4 class="modal-title"><?php echo getCatalog('tax') ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
				<input type="hidden" class="form-control" name="actiontype">
				<input type="hidden" class="form-control" name="taxid">
        <div class="row">
					<div class="col-md-4">
						<label for="taxcode"><?php echo getCatalog('taxcode') ?></label>
					</div>
					<div class="col-md-8">
        ...
        <div class="row">
					<div class="col-md-4">
						<label for="taxvalue"><?php echo getCatalog('taxvalue') ?></label>
					</div>
					<div class="col-md-8">
						<input type="number" class="form-control" name="taxvalue">
					</div>
				</div>
        <div class="row">
					<div class="col-md-4">
