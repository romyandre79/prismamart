<script src="<?php echo Yii::app()->baseUrl; ?>/js/common/supplier.js"></script>
<script src="<?php echo Yii::app()->theme->baseUrl;?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<div class="card card-purple">
	<div class="card-header with-border">
		<h3 class="card-title"><?php echo getCatalog('supplier') ?></h3>
</div>
	<div class="card-body">
     <?php $this->widget('Button',	array('menuname'=>'supplier')); ?>
		<?php
				...
				array
					...
					'buttons' => array
						...
						'delete' => array
							...
							'visible' => booltostr(CheckAccess('supplier', 'isreject')),
							'url' => '"#"',
							'click' => "function() {
						...
						'pdf' => array
							...
							'visible' => booltostr(CheckAccess('supplier', 'isdownload')),
							'url' => '"#"',
							'click' => "function() {
...
<?php $this->widget('SearchPopUp',array('searchitems'=>array(
  ...
  array('searchtype'=>'text','searchname'=>'npwpno'),
...
<?php $this->widget('HelpPopUp',array('helpurl'=>'https://www.youtube.com/embed/hDqrkdJcJbI')); ?>
<div id="InputDialog" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo getCatalog('supplier') ?></h4>
      </div>
...
<div id="InputDialogaddresscontact" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <h4 class="modal-title"><?php echo getCatalog('addresscontact') ?></h4>
        ...
        <div class="row">
					<div class="col-md-4">
						<label for="contactphoneno"><?php echo getCatalog('phoneno') ?></label>
					</div>
					<div class="col-md-8">
						<input type="text" class="form-control" name="contactphoneno">
					</div>
				</div>
        <div class="row">
					<div class="col-md-4">
