                  ...
                  <div class="col">
                    <div class="card card-tab card-tab-shadow-radius">
                      <div class="card-header">
                        <nav class="nav">
                          <a class="nav-link" href="<?php echo Yii::app()->createUrl('common/supplier/sellerulasan')?>">Rating Produk</a>
                          ...
                          <a class="nav-link active" href="<?php echo Yii::app()->createUrl('common/supplier/sellerpenaltyreward')?>">Penalty dan Reward</a>
                        </nav>
                      </div>
                      <div class="card-body">
