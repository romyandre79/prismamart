<script src="<?php echo Yii::app()->baseUrl; ?>/js/common/pricecategory.js"></script>
<script src="<?php echo Yii::app()->theme->baseUrl;?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<div class="card card-purple">
	<div class="card-header with-border">
		<h3 class="card-title"><?php echo getCatalog('pricecategory') ?></h3>
	</div>
	<div class="card-body">
    <?php $this->widget('Button',	array('menuname'=>'pricecategory')); ?>
		<?php
		$this->widget('zii.widgets.grid.CGridView',
			...
			'columns' => array(
				...
				array
					...
					'buttons' => array
						...
						'edit' => array
							...
							'visible' => booltostr(CheckAccess('pricecategory', 'iswrite')),
							'url' => '"#"',
							'click' => "function() {
						...
						'delete' => array
							...
							'visible' => booltostr(CheckAccess('pricecategory', 'isreject')),
							'url' => '"#"',
							'click' => "function() {
						...
						'purge' => array
							...
							'visible' => booltostr(CheckAccess('pricecategory', 'ispurge')),
							'url' => '"#"',
							'click' => "function() {
						...
						'pdf' => array
							...
							'visible' => booltostr(CheckAccess('pricecategory', 'isdownload')),
							'url' => '"#"',
							'click' => "function() {
				...
				array(
					'header' => getCatalog('pricecategoryid'),
...
<?php $this->widget('HelpPopUp',array('helpurl'=>'https://www.youtube.com/embed/aa62myPHAhY')); ?>
<div id="InputDialog" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      <h4 class="modal-title"><?php echo getCatalog('pricecategory') ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
				<input type="hidden" class="form-control" name="actiontype">
				<input type="hidden" class="form-control" name="pricecategoryid">
        <div class="row">
					<div class="col-md-4">
						<label for="categoryname"><?php echo getCatalog('categoryname') ?></label>
					</div>
					<div class="col-md-8">
