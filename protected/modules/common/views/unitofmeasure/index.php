<script src="<?php echo Yii::app()->baseUrl; ?>/js/common/unitofmeasure.js"></script>
<script src="<?php echo Yii::app()->theme->baseUrl;?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<div class="card card-purple">
	<div class="card-header with-border">
		<h3 class="card-title"><?php echo getCatalog('unitofmeasure') ?></h3>
			</div>
	<div class="card-body">
    <?php $this->widget('Button',	array('menuname'=>'unitofmeasure')); ?>
		<?php
		$this->widget('zii.widgets.grid.CGridView',
			...
			'columns' => array(
				...
				array
					...
					'buttons' => array
						...
						'edit' => array
							...
							'visible' => booltostr(CheckAccess('unitofmeasure', 'iswrite')),
							'url' => '"#"',
							'click' => "function() {
						...
						'delete' => array
							...
							'visible' => booltostr(CheckAccess('unitofmeasure', 'isreject')),
							'url' => '"#"',
							'click' => "function() {
						...
						'purge' => array
							...
							'visible' => booltostr(CheckAccess('unitofmeasure', 'ispurge')),
							'url' => '"#"',
							'click' => "function() {
						...
						'pdf' => array
							...
							'visible' => booltostr(CheckAccess('unitofmeasure', 'isdownload')),
							'url' => '"#"',
							'click' => "function() {
				...
				array(
					'header' => getCatalog('unitofmeasureid'),
...
<?php $this->widget('HelpPopUp',array('helpurl'=>'https://www.youtube.com/embed/ZVMfj-2xrdg')); ?>
<div id="InputDialog" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      <h4 class="modal-title"><?php echo getCatalog('unitofmeasure') ?></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
				<input type="hidden" class="form-control" name="actiontype">
				<input type="hidden" class="form-control" name="unitofmeasureid">
        <div class="row">
					<div class="col-md-4">
						<label for="uomcode"><?php echo getCatalog('uomcode') ?></label>
					</div>
					<div class="col-md-8">
						<input type="text" class="form-control" name="uomcode">
					</div>
				</div>
        <div class="row">
					<div class="col-md-4">
