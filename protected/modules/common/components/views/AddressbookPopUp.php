<?php
$sqldata = "select a.addressbookid,a.fullname,a.creditlimit,a.currentlimit,a.currentdebt 
		from addressbook a 
		where a.recordstatus = 1 and a.fullname like '%".(isset($_REQUEST['fullname'])
		? $_REQUEST['fullname'] : '')."%'";
...
<?php echo $this->IDField ?>ShowButtonClick();
		...
		$(":input[name*='<?php echo $this->IDField; ?>_search_fullname']").keyup(function (e) {
			if (e.keyCode == 13) {
<?php echo $this->IDField ?>searchdata()
			}
		});
