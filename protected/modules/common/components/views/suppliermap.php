...
$(document).ready(function(){
 ...
 var map = new google.maps.Map(document.getElementById("map_canvas_supplier"),myOptions);
 var image = {
 ...
 $companys = Yii::app()->db->createCommand("select a.addressbookid,fullname,b.lat,b.lng,creditlimit,currentlimit,b.addressname from addressbook a 
	...
	where isvendor=1 and fullname <> '' and fullname is not null")->queryAll();
...
<div class="box box-primary">
	...
	<div class="box-body">
	<div id="map_canvas_supplier" style="height:700px"></div>
	</div><!-- /.box-body -->
</div><!-- /.box -->