<?php
$sqldata = "select a.salesareaid,a.areaname
		from salesarea a 
		where a.recordstatus = 1 and a.areaname like '%".(isset($_REQUEST['areaname'])
		? $_REQUEST['areaname'] : '')."%'";
...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'areaname': $("input[name='<?php echo $this->IDField ?>_search_areaname']").val()
			}});
		return false;
	}
...
<div id="<?php echo $this->IDDialog ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">	
      ...
      <div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField ?>_search_areaname"><?php echo getCatalog('areaname') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField ?>_search_areaname" class="form-control">
							<span class="input-group-btn">
