<?php
$sqldata = "select a.contacttypeid,a.contacttypename
		from contacttype a 
		where a.recordstatus = 1 and a.contacttypename like '%".(isset($_REQUEST['contacttypename'])
		? $_REQUEST['contacttypename'] : '')."%'";
...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'contacttypename': $("input[name='<?php echo $this->IDField ?>']_search_contacttypename").val(),
...
<div id="<?php echo $this->IDDialog ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">	
      ...
      <div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField ?>_search_contacttypename"><?php echo getCatalog('contacttypename') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField ?>_search_contacttypename" class="form-control">
							<span class="input-group-btn">
