				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button name="<?php echo $this->ColField ?>SearchButton" type="button" class="btn btn-primary" onclick="<?php echo $this->IDField ?>searchdata()"><span class="fa fa-search"></span></button>
							</span>
						</div>
					</div>
				</div>
