<?php
$sqldata = "select a.materialgroupid,a.materialgroupcode,a.description
		from materialgroup a 
		where a.recordstatus = 1 and a.materialgroupcode like '%".(isset($_REQUEST['materialgroupcode'])
		? $_REQUEST['materialgroupcode'] : '')."%'
...
<script>
	function <?php echo $this->IDField ?>searchdata() {
		$.fn.yiiGridView.update("<?php echo $this->PopGrid ?>", {data: {
				'materialgroupcode': $("input[name='<?php echo $this->IDField ?>_search_materialgroupcode']").val(),
...
<div id="<?php echo $this->IDDialog ?>" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">	
      ...
      <div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<label class="control-label" for="<?php echo $this->IDField ?>_search_materialgroupcode"><?php echo getCatalog('materialgroupcode') ?></label>
					</div>
					<div class="col-md-8">
						<div class="input-group">
							<input type="text" name="<?php echo $this->IDField ?>_search_materialgroupcode" class="form-control">
							<span class="input-group-btn">
