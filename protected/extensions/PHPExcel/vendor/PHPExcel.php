...
class PHPExcel {
	...
	public function getRibbonXMLData($What = 'all') {//we need some constants here...
		...
		switch ($What) {
			...
			case 'target':
			case 'data':
				if (is_array($this->_ribbonXMLData) && array_key_exists($What,
						$this->_ribbonXMLData)) {
	 ...
	 *
	 */
	public function setRibbonBinObjects($BinObjectsNames = NULL,
																		 $BinObjectsData = NULL) {
	...
	public function getRibbonBinObjects($What = 'all') {
		...
		switch ($What) {
			...
			case 'names':
			case 'data':
				if (is_array($this->_ribbonBinObjects) && array_key_exists($What,
						$this->_ribbonBinObjects)) {
			...
			case 'types':
				if (is_array($this->_ribbonBinObjects) && array_key_exists('data',
					...
					$ReturnData	 = array_unique(array_map(array($this, '_getExtensionOnly'),
							$tmpTypes));
